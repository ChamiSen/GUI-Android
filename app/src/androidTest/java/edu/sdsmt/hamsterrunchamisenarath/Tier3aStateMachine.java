...
public class Tier3aStateMachine {
    ...
    private void init() {
        ...
        act.getScenario().onActivity(act -> {
            ...
            zoomAtom.set(act.findViewById(R.id.zoomView));
            moveAtom.set(act.findViewById(R.id.moveView));
            energyAtom.set(act.findViewById(R.id.energyView));
            storesAtom.set(act.findViewById(R.id.storesView));
            foodAtom.set(act.findViewById(R.id.foodView));
        });
